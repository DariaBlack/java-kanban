...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Epic epic2 = new Epic("Что-то грандиозное!", "Описание");
        ...
        Subtask subtask3 = new Subtask("Первая часть грандиозного", "Описание", Status.DONE, epic2.getId());
        Subtask subtask4 = new Subtask("Вторая часть грандиозного", "Описание", Status.DONE, epic2.getId());
